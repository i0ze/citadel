defmodule CitadelWeb.UserLive.Settings do
  use CitadelWeb, :live_view

  on_mount {CitadelWeb.UserAuth, :require_sudo_mode}
  ...
  def handle_event("update_profile", %{"user" => user_params}, socket) do
    ...
    case Accounts.update_user_profile(user, user_params) do
      {:ok, updated_user} ->
        info = "Profile was successfully updated."
